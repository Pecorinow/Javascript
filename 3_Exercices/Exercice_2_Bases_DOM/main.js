...
const IMG_RESULTAT = document.getElementById('image-moi');
...
BTN_VALIDER.addEventListener('click', () => {
    ...
    let age=INPUT_AGE.valueAsNumber; // car value ne fonctionne qu'avec les valeurs type text => préciser que c'est un type number ! + Pour les input nombres, écrire direct dans le html "type=number".
    ...
    IMG_RESULTAT.src = urlimage ; // REMPLACER LE CONTENU D'UN ATTRIBUT PAR UNE AUTRE VALEUR : écrire l'id de cette valeur sans () ni '' !!
